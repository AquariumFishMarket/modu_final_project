...
export const mockResponsesByRoom: Record<string, ChatMessage[]> = {
    ...
    "2": [
    { id: 'r3', userId: 'other2', username: 'ggamjang12', type: 'text', content: '2번 방 테스트', timestamp: Date.now() },
    ],
    "3": [
    { id: 'r4', userId: 'other3', username: '붕어빵', type: 'image', content: '/img/sample.png', timestamp: Date.now() },
    ],
};
